...
Тема ВКР: *«Разработка системы для автоматизации бизнес-процессов образовательного центра»*

---

## 1. Диаграмма вариантов использования (Use Case Diagram)

**Назначение:** Определение функциональных требований к системе и выделение акторов.
